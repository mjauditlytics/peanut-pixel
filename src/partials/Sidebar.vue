    ...
    <div id="sidebar" ref="sidebar"
      ...
      <div class="flex justify-between mb-10 pr-3 sm:px-2">
        ...
        <router-link class="block" to="/">
          <!-- <img src="@/images/logo-auditlytics.png" alt="Auditlytics logo" class="w-10 h-10" > -->
        ...
        <div>
          ...
          <ul class="mt-3">
            ...
            <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0"
              :class="currentRoute.fullPath === '/' || currentRoute.fullPath.includes('dashboard') && 'bg-slate-900'">
            ...
            <SidebarLinkGroup v-slot="parentLink" :activeCondition="currentRoute.fullPath.includes('ecommerce')">
              ...
              <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                  <router-link to="/audits/create" custom v-slot="{ href, navigate, isExactActive }">
                    <li class="mb-1 last:mb-0">
                      <a class="block transition duration-150 truncate"
                        :class="isExactActive ? 'text-indigo-500' : 'text-slate-400 hover:text-slate-200'" :href="href"
                        @click="navigate">
