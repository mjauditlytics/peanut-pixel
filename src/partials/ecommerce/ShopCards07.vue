<template>
  <!-- Card 1 -->
  <div class="col-span-full md:col-span-4 xl:col-span-3 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
    <div class="flex flex-col h-full">
      <!-- Image -->
      <div class="relative">
        <img class="w-full" src="../../images/applications-image-24-75pc.jpg" width="301" height="226" alt="Application 21" />
...
<div class="col-span-full md:col-span-4 xl:col-span-3 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
    <div class="flex flex-col h-full">
      <!-- Image -->
      <div class="relative">
        <img class="w-full" src="../../images/applications-image-28-75pc.jpg" width="301" height="226" alt="Application 21" />
